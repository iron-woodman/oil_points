...
IF exists(select * from sys.databases where [name] ='sts7_test')
begin
alter database [sts7_test] set single_user with rollback IMMEDIATE;
drop database  [sts7_test]
end
go
-- создаем БД
create database [sts7_test]
go
